...
import com.team2.service.InstructorService;
...
public class AddInstructorForm {
	...
	private void createForm() {
		...
		saveButton.setOnAction(e -> {
			handleAddInstructor(instructorNameField, instructorDepField, instructorEmailField);
		});

		vbox.getChildren().addAll(instructorNameLabel, instructorNameField, instructorDepLabel, instructorDepField,
				instructorEmailLabel, instructorEmailField, saveButton);
	...
	private void handleAddInstructor(TextField instructorNameField, TextField instructorDepField,
			TextField instructorEmailField) {
		try {
